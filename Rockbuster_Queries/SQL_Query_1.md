...
```sql
SELECT 
    name AS name_of_genre, 
    COUNT(A.rental_id) AS total_number_of_rentals, 
    AVG(rental_duration) AS average_rental_duration -- 'name' from film category renamed 'name_of_genre'
FROM 
    rental A
